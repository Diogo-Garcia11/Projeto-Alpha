...
$para = $email; 
$de = 'murillo.joaquim@etec.sp.gov.br';
$de_nome = 'Murillo Prevealato Gabriel Joaquim';
$assunto = $opcoes; 
...
$Vai    = "Nome: $nome\n\nE-mail: $email\n\nTelefone: $telefone\n\nMensagem: $mensagem\n\nResposta: $corpo";
 ...
 if (smtpmailer($email, 'murillo.joaquim@etec.sp.gov.br', 'Murillo Prevelato Gabriel Joaquim', 'Resposta do Contato', $Vai)) {
